...
CREATE TABLE IF NOT EXISTS raw.raw_m_loan_repayment_schedule (
    tenant_id                       TEXT NOT NULL,
    id                              BIGINT NOT NULL,
    loan_id                         BIGINT NOT NULL,
    fromdate                        DATE,
    ...
    total_paid_in_advance_derived   NUMERIC(19,6),
    total_paid_late_derived         NUMERIC(19,6),
    completed_derived               BOOLEAN NOT NULL DEFAULT FALSE,
    obligations_met_on_date         DATE,
    is_re_aged                      BOOLEAN NOT NULL DEFAULT FALSE,
    lastmodified_date               TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    source_loaded_at                TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    PRIMARY KEY (tenant_id, id)
);
